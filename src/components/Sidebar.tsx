...
export default function Sidebar({ session, client, activeView, onNavigate, onLogout }: SidebarProps) {
  ...
  return (
    <aside className="w-64 h-screen flex flex-col shrink-0 border-r border-border/60"
      style={{
      ...
      <div className="p-5 border-b border-border/50">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg flex items-center justify-center text-xs font-black text-primary-foreground font-heading"
